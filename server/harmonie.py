...
ss.latex(r"where $m$ is the number of measurements, $z_{i}$ is the measured value, $h_{i}(x)$ is the estimated value, and $sigma_{i}$ is the measurement error.", math=False, to=card)
